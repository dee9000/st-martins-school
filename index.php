<?php include 'header.php';?>
  ...
  <img class="d-block w-100" src="img/car-img1.jpg" alt="First slide">
  </div>
  <div class="carousel-item overlay">
  <img class="d-block w-100" src="img/car-img2.jpg" alt="Second slide">
  </div>
  <div class="carousel-item overlay">
  <img class="d-block w-100" src="img/car-img3.jpg" alt="Third slide">
  </div>
  <div class="carousel-item overlay">
  <img class="d-block w-100" src="img/car-img4.jpg" alt="Fourth slide">
  </div>
  <div class="carousel-item overlay">
  <img class="d-block w-100" src="img/car-img5.jpg" alt="Fifth slide">
  </div>
  </div>
...
<!--headteacher welcome section-->
<div class="headteacher-section">
<div class="container-fluid p-3 highlight-pill headteacher-pill">
  <div class="row featurette mx-auto">
    <div class="col-md-5" data-aos="fade-right">
        <img src="img/teacher.jpeg" alt="holder image">
    </div>
...
<div class="album py-5">
    <div class="container pt-25 pt-43 pb-12"  data-aos="fade-up">
      <h1 class="text-xl-left">Discover St.Martins</h1>
      <div class="row">
        <div class="col-md-4">
  ...
  <div class="svg-container">
    <div class="custom-shape-divider-bottom-1656494698">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M1200 0L0 0 892.25 114.72 1200 0z" class="shape-fill"></path>
        </svg>
    </div>
  </div>
      <!--content section 2 for vision and values-->
        <div class="container-fluid p-3 visions-and-values">
          <div class="row featurette mx-auto">
            <div class="col-md-7">
          ...
          <!--horizons 6th form section-->

          <div class="container-fluid p-3 highlight-pill horizons-beige">
            <div class="row featurette mx-auto">
              <div class="col-md-5" data-aos="fade-down">
                  <img src="img/holder11.png" alt="holder image">
              </div>
              <div class="col-md-7" data-aos="fade-left">
            ...
            <div class="py-5 my-5 news-and-events">
             ...
             <!--svg-->
             <div class="svg-container">
               <div class="custom-shape-divider-top-1656928898">
       <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
           <path d="M1200 0L0 0 598.97 114.72 1200 0z" class="shape-fill"></path>
       </svg>
             </div>
